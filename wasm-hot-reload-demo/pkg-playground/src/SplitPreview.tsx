...
import initWasm, { BamlProject, version, hot_reload_test_string } from '@demo/playground-wasm';
    ...
    initWasm()
      .then(() => {
        try {
          ...
          metaTag.name = 'playground-version';
          metaTag.content = ver;
    ...
    <section style={containerStyles}>
      ...
      <article style={panelStyles}>
        ...
        <textarea
          ...
          placeholder="Start typing here, e.g.:&#10;&#10;function MyFunction(input: string) -> string {&#10;  // function body&#10;}"
        />
      </article>
      <article style={panelStyles}>
        <header style={headerStyles}>Functions</header>
