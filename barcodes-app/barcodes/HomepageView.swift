...
struct HomepageView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            #if DEBUG
            // Screenshot helper: auto-open the first barcode's detail view.
            if ProcessInfo.processInfo.arguments.contains("-showDetail"),
               selectedBarcodeID == nil,
               let first = barcodes.first {
                selectedBarcodeID = first.persistentModelID
            }
            #endif
        }
        .toolbar {
